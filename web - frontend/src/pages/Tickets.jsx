...
import { assignSupportTicket, createSupportTicket, getStoredUser, getSupportTickets, getInventory } from '../services/api.js';

const emptyForm = { ticketType: 'service', companySector: '', location: '', relatedProblem: '', observations: '', attachmentName: '', equipmentId: '' };
...
function Tickets() {
  ...
  useEffect(() => {
    Promise.all([getSupportTickets(), getInventory()])
      .then(([ticketsData, inventoryData]) => {
